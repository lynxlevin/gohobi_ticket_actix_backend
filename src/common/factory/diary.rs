...
pub trait DiaryFactory {
    ...
    fn user_1_status(self, user_1_status: &str) -> diaries_diary::ActiveModel;
    fn user_2_status(self, user_2_status: &str) -> diaries_diary::ActiveModel;
}
...
impl DiaryFactory for diaries_diary::ActiveModel {
    ...
    fn user_1_status(mut self, user_1_status: &str) -> diaries_diary::ActiveModel {
        self.user_1_status = Set(user_1_status.to_string());
        self
    }

    fn user_2_status(mut self, user_2_status: &str) -> diaries_diary::ActiveModel {
